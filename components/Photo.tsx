  ...
  return (
    <div className="w-full h-full relative">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: {delay: 2, duration: 0.4, ease: "easeIn"}, }}>
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: {delay: 2, duration: 0.4, ease: "easeIn"}, }} className="w-[298px] h-[298px] xl:h-[498px] xl:w-[498px] mix-blend-lighten absolute">
            <Image src="/assets/photo3.png" priority quality={100} fill alt="" className="object-contain rounded-full"/>
        </motion.div>
        {/* circle */}
